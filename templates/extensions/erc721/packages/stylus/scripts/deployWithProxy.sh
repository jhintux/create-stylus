...
echo ""
echo "--------------------------"
echo "Deploying ERC-721 contract"
echo "--------------------------"
...
initialize_data=0x
forge build
forge create --rpc-url $RPC_URL --private-key $PRIVATE_KEY src/Proxy.sol:Proxy --constructor-args $erc721_contract_address $ADDRESS $initialize_data > $DEPLOY_CONTRACT_RESULT_FILE
...
echo "Solidity ERC-721 contract deployed at address: $erc721_contract_address"
echo "Proxy contract deployed at address: $proxy_contract_address"
